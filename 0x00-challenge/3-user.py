...
if __name__ == '__main__':
    ...
    user_2.password = "89"  # changed from integer to string
    if user_2.password is not None:
        print("User.password should be None if setter to a non-string value")
    ...
    if user_1.is_valid_password("89"):
        print("is_valid_password should return False if compared with a string representation of an integer")
